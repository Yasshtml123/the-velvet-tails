        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-10">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="flex justify-end mt-2">
                  <button type="button" className="text-xs text-charcoal/60 hover:text-plum transition-colors font-sans hover:underline">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-4 bg-velvet-purple hover:bg-velvet-purple/90 text-white font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
              >
                {isLoading ? (
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link to="/register" className="text-velvet-purple hover:text-velvet-purple/80 font-medium">
                Sign up
              </Link>
            </p>
