...
import { 
    ...
    Facebook, Twitter, MessageCircle, Link2, ShoppingBag 
} from 'lucide-react';
                ...
                <div className="lg:col-span-5 flex flex-col space-y-6">
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div className="flex items-center justify-center gap-4 pt-4 text-charcoal/50">
                            ...
                            <button className="hover:text-blue-600 transition-colors"><Facebook className="w-4 h-4" /></button>
                            <button className="hover:text-blue-400 transition-colors"><Twitter className="w-4 h-4" /></button>
